              ...
              <div className="flex flex-row items-start sm:items-center gap-3 sm:gap-4">
                <MagneticButton className="shrink-0">
                  <motion.div
                    ...
                    className="icon-orbit grid h-12 w-12 sm:h-14 sm:w-14 shrink-0 place-items-center rounded-2xl border border-line bg-primary/10 text-primary cursor-pointer select-none"
                  >
