...
export function LoadingSpinner({ delay = 250 }: { delay?: number }) {
    ...
    <AnimatePresence>
      {show && (
        <motion.div
          ...
          className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-canvas/60 backdrop-blur-md select-none"
        >
